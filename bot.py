...
async def start(update: Update, context: CallbackContext) -> int:
    ...
    if user_id not in user_data:
        ...
        await update.message.reply_text('🌠Этот бот поможет вам создать пост для группы Anemone. Изначально пост будет виден исключительно вам, так что не бойтесь пробовать, экспериментировать и смотреть что получится\n \nДля начала, пожалуйста, отправьте ссылку на автора. Если у вас её нет то отправьте любой текст\n \n <i>В боте есть команда /restart которая перезапускает процесс на любом этапе</i>\n',
    parse_mode='HTML')
...
# Отправка сообщения с количеством изображений
                ...
                await update.message.reply_text(
                    '✅Все данные для публикации успешно созданы.\n Но сейчас они видны только вам, чтобы поделиться ими с администрацией просто нажмите /share (эта кнопка будет работать только до вашего следующего нажатия команды publish) \n\n Либо создайте другую публикацию если что-то пошло не так. \n\nВы так же можете ввести команду /send чтобы перейти в режим прямой связи с администрацией. Просто нажмите на эту команду и после этого любые ваши сообщения отправленные боту будут пересылаться администрации. Таким образом вы можете задать вопросы, отправить дополнительные файлы, изображения и пояснения касательно вашей публикации, сообщить об обнаруженных багах или что-то ещё. \n\n  ✅*Бот перезапущен успешно.*\n\n(=^・ェ・^=)',
