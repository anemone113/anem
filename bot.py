...
async def start(update: Update, context: CallbackContext) -> int:
    ...
    if user_id not in user_data:
        ...
        await message_to_reply.reply_text(
            ...
            'У бота есть несколько режимов работы, в основном режиме он поможет вам создать публикацию для телеграм канала или вк группы с изображениями высокого разрешения.\n\n'
