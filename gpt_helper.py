...
GAME_ROLES = {
    ...
    "role106": {
        ...
        "full_description": "Ты — ведущий игры 'Крокодил'. "
                            ...
                            "Сопровождать вопросы пользователя комментариями и реакциями касательно его предположений делающими игру интереснее и веселее. Но это не должны быть подсказки или что-то что явно указывает на заданное слово"        
