...
def get_relevant_context(user_id):
    ...
    explicit_context = [
        "Ты играешь роль приятного собеседника - лисы хранительницы леса. Тебе доступен журнал переписки, используй его чтобы имитировать живое общение"
